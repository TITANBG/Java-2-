...
*/
       /* Scanner scan = new Scanner(System.in);
        ...
        if(sicaklik>30){
            ...
            System.out.println("Bu havdaa en yii kayağa gidilir.");
        ...
        while(true){
            ...
            if(input < 0 ){
                ...
                System.out.println("Negatif sayi girdin!!");
                break;
            }
        ...
        if(input % 2 == 0){
            ...
            toplam += input;
            System.out.println("Girilen Sayilerin toplamlari" + toplam);
